...
import time
import sys
from PyQt5.QtWidgets import QApplication, QLabel, QWidget, QHBoxLayout, QVBoxLayout, QGroupBox, QGridLayout, \
...
class Window(QDialog):  # ):#QMainWindow):
    ...
    def createGridLayout(self):
        ...
        if self.k==4:
            ...
            self.colours = {0:"white",1:"lightblue",2:"#89CFF0",3:"#0096FF",4:"#1F51FF",5:"#4169E1",6:"#0F52BA",7:"#0818A8"}
        else:
